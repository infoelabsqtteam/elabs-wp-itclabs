 ...
 * @since 1.0.0
 */
class TS_imgselect extends \Elementor\Base_Data_Control {
    ...
    public function enqueue() {
		// Styles
		wp_register_style( 'ts-elementor-base', get_template_directory_uri() . '/includes/elementor-base.css' );
		wp_enqueue_style( 'ts-elementor-base' );
	}
