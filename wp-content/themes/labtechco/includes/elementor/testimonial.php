 ...
 */
class TS_TestimonialElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'ts_testimonial_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'LabtechCO Testimonial Element', 'labtechco' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Testimonial Category?', 'labtechco' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Testimonial Category ?', 'labtechco' ),
				'description' => esc_attr__( 'Select YES to show sortable Testimonial Category.', 'labtechco' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'labtechco' ),
				'label_off' => esc_attr__( 'No', 'labtechco' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'boxstyle',
			[
				'label'			=> esc_attr__( 'Select Testimonial View Style', 'labtechco' ),
				'description'	=> esc_attr__( 'Slect Testimonial View style.', 'labtechco' ),
				'type'			=> 'ts_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> 'style-1',
				'options'		=> themestek_global_template_list( 'testimonial', 'labtechco' ),
			]
		);
		$this->end_controls_section();
	...
	protected function select_category() {
        $category = get_terms( array( 'taxonomy' => 'ts-testimonial-group', 'hide_empty' => false ) );
	  	$cat = array();
...
Plugin::instance()->widgets_manager->register( new TS_TestimonialElement() );