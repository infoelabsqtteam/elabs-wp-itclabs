 ...
 */
class TS_PortfolioElement extends Widget_Base{

 	// The get_name() method is a simple one, you just need to return a widget name that will be used in the code.
	public function get_name() {
		return 'ts_portfolio_element';
	}

	// The get_title() method, which again, is a very simple one, you need to return the widget title that will be displayed as the widget label.
	public function get_title() {
		return esc_attr__( 'LabtechCO Portfolio Element', 'labtechco' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'from_category',
			[
				'label' => esc_attr__( 'Show Post from selected Portfolio Category?', 'labtechco' ),
		...
		$this->add_control(
			'sortable',
			[
				'label' => esc_attr__( 'Show Sortable Portfolio Category ?', 'labtechco' ),
				'description' => esc_attr__( 'Select YES to show sortable Portfolio Category.', 'labtechco' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_attr__( 'Yes', 'labtechco' ),
				'label_off' => esc_attr__( 'No', 'labtechco' ),
				'return_value' => 'yes',
		...
		$this->add_control(
			'boxstyle',
			[
				'label'			=> esc_attr__( 'Select Portfolio View Style', 'labtechco' ),
				'description'	=> esc_attr__( 'Slect Portfolio View style.', 'labtechco' ),
				'type'			=> 'ts_imgselect',
				'label_block'	=> true,
				'thumb_width'	=> '110px',
				'default'		=> 'style-1',
				'options'		=> themestek_global_template_list( 'portfolio', 'elementor' ),
			]
		);
		$this->end_controls_section();
...
Plugin::instance()->widgets_manager->register( new TS_PortfolioElement() );