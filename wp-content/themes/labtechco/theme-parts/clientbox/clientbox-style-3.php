...
?>
<div class="themestek-box themestek-box-client ts-clientbox-style-3 themestek-box-view-style3 themestek-client-box-view-style3 <?php if( $show_hover=='yes' && !empty($hover_img) ) { ?> themestek-clientbox-hover-exists <?php } ?>">
