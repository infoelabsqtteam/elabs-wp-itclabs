<article class="themestek-box themestek-box-blog ts-blogbox-style-6 themestek-box-style6 themestek-blogbox-format-<?php echo get_post_format() ?> <?php echo themestek_sanitize_html_classes(themestek_post_class()); ?>">
	<div class="post-item">
