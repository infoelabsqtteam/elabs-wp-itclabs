<article class="themestek-box themestek-box-blog ts-blogbox-style-9 themestek-box-style9 ts-hover-style-3 themestek-blogbox-format-<?php echo get_post_format() ?> <?php echo themestek_sanitize_html_classes(themestek_post_class()); ?>">
	<div class="post-item">
