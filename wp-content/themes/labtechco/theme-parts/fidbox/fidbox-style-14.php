		...
		<div class="ts-circle-outer"
			...
			<div class="ts-fid-desc-w">
				<div class="ts-fid-title-w">
					<h4 class="ts-fid-subtitle"><span><?php echo esc_attr($ts_global_fid_element_values['subtitle']); ?></span></h4>
					<h3 class="ts-fid-title"><span><?php echo esc_attr($ts_global_fid_element_values['title']); ?><br></span></h3>
				</div>
				<div class="ts-fid-desc">
					<span><?php echo esc_attr($ts_global_fid_element_values['desc']); ?></span>
				</div>
			</div>
		</div>
	</div><!-- .ts-fld-contents -->
