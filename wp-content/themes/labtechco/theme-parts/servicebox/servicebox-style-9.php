<article class="themestek-box themestek-box-service ts-servicebox-style-9">
	<div class="themestek-post-item">
		
		<div class="themestek-box-content">
            <div class="themestek-box-content-inner d-flex">
	...
	<div class="themestek-hover-img">
		<?php echo themestek_get_featured_media('', 'themestek-img-800x508'); ?>
	</div>
</article>