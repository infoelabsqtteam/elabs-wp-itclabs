			...
			while ( have_posts() ) : the_post();
				...
				if( themestek_get_option('blog_view') == 'box' ){
					...
					echo themestek_column_div('start', themestek_get_option('blogbox_column') );
						$box_style = themestek_get_option('blogbox_boxstyle');
						if( empty($box_style) ){ $box_style = 'style-1'; }
						echo get_template_part('theme-parts/blogbox/blogbox', esc_attr($box_style) );
